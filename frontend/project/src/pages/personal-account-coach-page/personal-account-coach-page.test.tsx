...
describe('Component: PersonalAccountCoachPage', () => {
  it('should render correctly', () => {
    ...
    expect(workoutLink.href).toContain(`${AppRoute.PersonalAccountCoach}/workouts`);

    const friendLink: HTMLAnchorElement = screen.getByTestId('friends');
    expect(friendLink.href).toContain(`${AppRoute.PersonalAccountCoach}/friends`);
