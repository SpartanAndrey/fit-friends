...
import { MIN_NAME_LENGTH, MAX_NAME_LENGTH, MIN_DESCRIPTION_LENGTH, MAX_DESCRIPTION_LENGTH, AUTH_USER_NAME_LENGTH, AUTH_DESCRIPTION_LENGTH, AUTH_USER_DATEBIRTH_NOT_VALID, MAX_WORKOUT_TYPE_NUMBER, AUTH_WORKOUT_TYPE_NUMBER, MIN_CALORIES_NUMBER, MAX_CALORIES_NUMBER, AUTH_CALORIES_NUMBER } from '../bff.constant';
